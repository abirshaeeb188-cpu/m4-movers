export const testimonials = [
  {
    ...
    rating: 5,
    review:
      'M4 Movers relocated our entire villa in Arabian Ranches in a single day. The crew wrapped every piece of furniture and nothing was damaged. Genuinely impressed.',
  ...
  },
  {
    ...
    rating: 5,
    review:
      'Used their storage solution for two months between leases. Everything came back exactly as packed, clean and undamaged. Will use again.',
...
export const faqs = [
  {
    ...
    a: 'We cover all seven Emirates — Dubai, Abu Dhabi, Sharjah, Ajman, Umm Al Quwain, Ras Al Khaimah, and Fujairah — for local, inter-emirate, and international moves.',
  },
  {
    q: 'How far in advance should I book my move?',
    a: 'We recommend booking 3–5 days ahead for standard moves and 2 weeks ahead for villas or international relocations, though same-day slots are often available.',
  },
  {
    q: 'Do you provide packing materials?',
    a: 'Yes. Boxes, bubble wrap, furniture blankets, and tape are included in our full-service packages, or available as a stand-alone packing service.',
  },
  {
    q: 'Is my furniture insured during the move?',
    a: 'Every move includes basic transit insurance, with optional extended coverage available for high-value or fragile items — ask our team for a quote.',
  },
  {
    q: 'Can you move on Fridays or weekends?',
    a: 'Yes, we operate seven days a week including Fridays and public holidays, at no extra call-out charge.',
  },
  {
    q: 'Do you disassemble and reassemble furniture?',
    a: 'Yes, our crews disassemble wardrobes, beds, and modular furniture before the move and rebuild them at your new address.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes, including offices, retail stores, clinics, and warehouses, with after-hours and weekend scheduling to avoid business downtime.',
  },
  {
    q: 'How do I track my move on the day?',
    a: 'All our trucks are GPS-tracked and your assigned move manager will share live updates via WhatsApp or phone throughout the day.',
  },
  {
