      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <Link to="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display -ml-2 font-bold text-xl text-white">
              M4 <span className="text-brand">Movers</span>
            </span>
          </Link>
          <p className="text-sm leading-relaxed text-white/60 mb-5">
            Licensed movers and packers serving homes and businesses across the
            ...
            {[FacebookIcon, InstagramIcon, LinkedinIcon, TwitterIcon].map(
              (Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="h-9 w-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand transition-colors">
                  <Icon size={15} />
                </a>
              ),
            )}
        ...
        <div>
          ...
          <p className="text-sm text-white/60 mb-4">
            Moving tips and offers, straight to your inbox.
          </p>
          ...
          <ul className="space-y-2.5 text-sm mt-6">
            ...
            <li className="flex items-center gap-2">
              <Mail size={14} className="text-brand" /> Info@m4movers.com
            </li>
            <li className="flex items-center gap-2">
